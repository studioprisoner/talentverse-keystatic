    ...
    return(
        <div>
            ...
            <section className="px-6 py-32 lg:px-8">
                <div className="px-6 mx-auto text-base leading-7 text-gray-700 max-w-7xl lg:px-8">
                ...
                <div className="px-6 mx-auto mt-10 max-w-7xl lg:px-8">
                <div className="grid items-start max-w-2xl grid-cols-1 mx-auto gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    ...
                    <div className="grid grid-cols-1 py-16 place-content-center">
